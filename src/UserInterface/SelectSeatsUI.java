...
public class SelectSeatsUI {
    public static ArrayList<MovieTicket> SelectSeatsUserInterface(Customer customer, Cineplex cineplex, Movie chosenMovie, ArrayList<Object> sSTnC) throws IOException {
